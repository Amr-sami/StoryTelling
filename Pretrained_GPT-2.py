...
def main():
    ...
    model_args = ModelArguments(
        model_name_or_path="gpt2", model_type="gpt2", cache_dir="/u0/psvadrev/.cache"
    )
    ...
    training_args = TrainingArguments(
        output_dir="D:\Lastyear\GP\Genre-Based-Story-Generator-master\story_generator_6_genre_eval",
